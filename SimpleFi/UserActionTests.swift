...
class UserActionTests: XCTestCase {
	...
	func testAddFolder() {
		...
		testArray = self.userAction.addFolder(WithName: "folder1", AndLevel: 0, AtFilePath: "/", Into: testArray)
	...
	func testAddFile() {
		...
		testArray = self.userAction.addFile(WithName: "folder1", AndLevel: 0, AtFilePath: "/", Into: testArray)
